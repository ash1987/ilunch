...
public class BookingListAdapter extends BaseAdapter {
	...
	public BookingListAdapter(Context mContext, ArrayList<Body> list, ArrayList<GetCartListBean.Body> cartList, Callback callback) {
...
//		if (converView == null) {
			converView = inflater.inflate(R.layout.food_list_item_layout,
					null);
			...
			holder.commentTv = (TextView) converView
...
//		}
		...
		imageLoader.displayImage(AndroidUtils.getImgUrlOnServer(data.get(
		...
		holder.good_mall_price_tv.setText(String.format(mContext.getString(R.string.merchant_publish_string), data.get(position).getName()));
		
		holder.priceTv.setText(data.get(position).getPrice());
		
		holder.hasMaiTv.setText(String.format(mContext.getString(R.string.ramain_num), data.get(position).getRemains()));
		
		holder.addToCartIv.setOnClickListener(new AddOnclick(holder, data.get(position), callback));

		holder.up_num_ib.setOnClickListener(new UpNumOnclick(holder, data.get(position), callback));
