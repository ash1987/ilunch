 ...
 * 打包/订座adapter
 */
public class BookingListAdapter1 extends BaseAdapter {
	...
	public BookingListAdapter1(Context mContext, ArrayList<Body> list,
	...
	public View getView(final int position, View converView, ViewGroup viewGroup) {
		...
		// if (converView == null) {
		converView = inflater.inflate(R.layout.food_list_item_layout1, null);
