 ...
 * 我的位置-城市适配器
 */
public class MyLocationCityAdapter extends BaseAdapter {
	private Context mContext;
	private LinkedList<Body> dataList;

	public MyLocationCityAdapter(Context mContext, LinkedList<Body> dataList) {
	...
	public View getView(int position, View converView, ViewGroup arg2) {
		...
		holder.cityTxt.setText(dataList.get(position).getCityName());
